 ...
 * @author jimmy
 */
public class VathmologiaCON {
    private VathmologiaUI uiVathmologia;
    ...
    public VathmologiaCON(Foititis foititis) {    
        this.user=foititis;       
        ihu.loadMathimata();
        ihu.loaddhlwseis();
        ...
        uiVathmologia = new VathmologiaUI(this,foititis);
        uiVathmologia.setVisible(true);
